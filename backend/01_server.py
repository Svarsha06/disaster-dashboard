...
# Store data in memory (in real app, use database)
disaster_data = {
    "points": [],
    "missions": [],
...
def assign_mission():
    ...
    agency = data.get("agency")  # "ngo" or "ndrf"
...
def update_points():
    """Update disaster points (simulate ESP32 updates)"""
    ...
    for point in disaster_data["points"]:
        ...
        point["water_level"] += random.randint(-5, 5)
        point["rainfall"] += random.randint(-3, 3)
